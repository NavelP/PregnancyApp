...
public class upcomingAppointmentsAdapterPhysical extends RecyclerView.Adapter<upcomingAppointmentsAdapterPhysical.MyHolder> {
    Context context;
    ArrayList<upcomingAppointmentsP> upcomingAppointments;

    public upcomingAppointmentsAdapterPhysical(Context context, ArrayList<upcomingAppointmentsP> upcomingAppointments) {
    ...
    public MyHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.single_upcoming_appointment_physical, parent, false);
